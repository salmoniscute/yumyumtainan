...
public class Store {
    ...
    public void setAll(String name, int cost, int worldX, int worldY, String path_photo1, String path_storeImage) {
        this.name = name;
        this.cost = cost;
    ...
    public void setAll(String name, int cost, int worldX, int worldY, int photoX, int photoY, String path_photo1, String path_storeImage) {
        this.name = name;
        this.cost = cost;
        this.worldX = gamePanel.tileSize * worldX;
        this.worldY = gamePanel.tileSize * worldY;
    ...
    public void setAll(String name, int cost, int worldX, int worldY, String which, int modify, String path_photo1, String path_storeImage) {
        if(which == "x"){
            this.name = name;
            this.cost = cost;
            this.worldX = gamePanel.tileSize * worldX;
    ...
    public void setAll(String name, int cost, int worldX, int worldY,String which, int modifyX, int modifyY, String path_photo1, String path_storeImage) {
        if (which == "xy") {
            this.name = name;
            this.cost = cost;
            this.worldX = gamePanel.tileSize * worldX;
            this.worldY = gamePanel.tileSize * worldY;
            this.photoX = gamePanel.tileSize * photoX + modifyX;
            this.photoY = gamePanel.tileSize * photoY + modifyY;
            this.photo1 = setup(path_photo1, photoWidth, photoHeight);
            this.storeImage = setup(path_storeImage, imageWidth, imageHeight);
        }
    }
